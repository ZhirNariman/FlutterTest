...
import 'package:sport/Screens/basketland.dart';
...
class BasketMeter extends StatefulWidget {
  final String value1;
  final String value2;
  //City item;
  const BasketMeter({
...
enum Onientataion { landscape, portrait }

class _BasketMeterState extends State<BasketMeter> {
  Box<TeamsInfo>? teams;
  Box<History>? history;
